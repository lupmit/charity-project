					...
					<div className={styles.contentLeft}>
						...
						<div className={styles.page}>
							...
							<a
								data-bn-type="link"
								target="_blank"
								href="https://www.linkedin.com/company/binance-charity-foundation"
								class={styles.link}
							>
								<svg
							...
							<a
								data-bn-type="link"
								target="_blank"
								href="https://twitter.com/BinanceBCF"
								class={styles.link}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<a
								data-bn-type="link"
								target="_blank"
								href="https://www.instagram.com/explore/tags/binancecharity/"
								class={styles.link}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<a
								data-bn-type="link"
								target="_blank"
								href="https://t.me/joinchat/tscsriF31lk1ZWJh"
								class={styles.link}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
